...
writer_reader_data= pd.read_csv("../data_complete/producer_consumer.CSV")
...
writer_reader_data= pd.read_csv("../data_complete/producer_consumer_mod.CSV")
...
writer_reader_data= pd.read_csv("../data_complete/producer_consumer_2.CSV")
mean = writer_reader_data.groupby(["n_thread"]).mean()["time"]
var = writer_reader_data.groupby(["n_thread"]).std()["time"]


writer_reader_data= pd.read_csv("../data_complete/producer_consumer_mod_2.CSV")
mean_mod = writer_reader_data.groupby(["n_thread"]).mean()["time"]
var_mod = writer_reader_data.groupby(["n_thread"]).std()["time"]
...
plt.ylabel("Execution time[s]")
plt.title("Execution time according to the number of threads\n with 4 constant producers")
plt.grid(True)
plt.savefig("../plot/producer_consumer_2.PNG")
plt.close()

writer_reader_data= pd.read_csv("../data_complete/producer_consumer_3.CSV")
mean = writer_reader_data.groupby(["n_thread"]).mean()["time"]
var = writer_reader_data.groupby(["n_thread"]).std()["time"]

writer_reader_data= pd.read_csv("../data_complete/producer_consumer_mod_3.CSV")
mean_mod = writer_reader_data.groupby(["n_thread"]).mean()["time"]
var_mod = writer_reader_data.groupby(["n_thread"]).std()["time"]
...
plt.xlabel("Number of Threads for readers")
plt.ylabel("Execution time[s]")
plt.title("Execution time according to the number of threads\n producer consumer with 12 constant producers")
plt.grid(True)
plt.savefig("../plot/producer_consumer_3.PNG")
plt.close()

writer_reader_data= pd.read_csv("../data_complete/producer_consumer_4.CSV")
mean = writer_reader_data.groupby(["n_thread"]).mean()["time"]
var = writer_reader_data.groupby(["n_thread"]).std()["time"]

writer_reader_data= pd.read_csv("../data_complete/producer_consumer_mod_4.CSV")
mean_mod = writer_reader_data.groupby(["n_thread"]).mean()["time"]
var_mod = writer_reader_data.groupby(["n_thread"]).std()["time"]
...
plt.ylabel("Execution time[s]")
plt.title("Execution time according to the number of threads\n producer consumer with 4 constant consumers")
plt.grid(True)
plt.savefig("../plot/producer_consumer_4.PNG")
plt.close()

writer_reader_data= pd.read_csv("../data_complete/producer_consumer_5.CSV")
mean = writer_reader_data.groupby(["n_thread"]).mean()["time"]
var = writer_reader_data.groupby(["n_thread"]).std()["time"]

writer_reader_data= pd.read_csv("../data_complete/producer_consumer_mod_5.CSV")
mean_mod = writer_reader_data.groupby(["n_thread"]).mean()["time"]
var_mod = writer_reader_data.groupby(["n_thread"]).std()["time"]
...
plt.xlabel("Number of Threads for writers")
plt.ylabel("Execution time[s]")
plt.title("Execution time according to the number of threads\n producer consumer with 12 constant consumers")
plt.grid(True)
